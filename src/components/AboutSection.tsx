            ...
            >
              ...
              >
                <motion.span
                  ...
                  initial="closed"
                  animate={hasDeployedPopdown ? "open" : "closed"}
                  className="relative z-10 flex h-full items-center justify-center px-6 pt-[26px] text-sm font-mono tracking-[0.2em] uppercase text-background group-hover/pill:text-[hsl(var(--highlight))] transition-colors duration-300"
                >
                  Get in touch
