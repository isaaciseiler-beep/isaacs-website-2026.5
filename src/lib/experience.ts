...
export const experienceEntries: ExperienceEntry[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "I managed a teaching team of 12 for a 150 person political science seminar course.",
      "The role required coordination across instructors and student staff, regular feedback workflows, and operational support for a large undergraduate classroom.",
    ],
  ...
  },
  {
    ...
    paragraphs: [
      "I led major rebrand and strategy work, including the first quantitative performance benchmark for CSR programs.",
      "I built a company-wide newsletter system with an 80% open rate and shipped dozens of major cross-functional communications assets.",
    ...
    projectIds: ["boehringer-cares-foundation-rebrand-strategy-shift"],
    newsIds: [],
  },
  {
    id: "boehringer-communications-operations",
    organization: "Boehringer Ingelheim",
    organizationUrl: "https://www.boehringer-ingelheim.com/",
    ...
    paragraphs: [
      ...
      "I completed the first comprehensive report for company sustainability initiatives across the U.S.",
      "I supported operations around health access and sustainable development programs, translating internal work into clearer strategy and communications materials.",
    ],
    focus: ["internal operations", "cross-functional execution", "systems design", "stakeholder communications"],
    projectIds: ["sustainable-development-health-access-report"],
    newsIds: [],
  },
  {
  ...
  },
  {
    ...
    image: "/experience/washu2.jpg",
    paragraphs: [
      "I provided guidance for departmental AI policy and delivered feedback on 120+ student products.",
      "The work combined classroom support, student writing feedback, and practical thinking about how AI tools should be handled in undergraduate political science courses.",
    ],
    focus: ["teaching support", "AI policy", "student feedback"],
    projectIds: [],
    newsIds: [],
  },
  {
